class Query:
    ...
    setup_queries = [drop_database, create_database, use_database, create_table_item, create_table_inv,
        create_table_customer, create_table_sales, create_table_advances, alter_table_item, alter_table_inv,
        alter_table_customer, alter_table_sales, alter_table_advances]
    tables = ['Item', 'Inventory', 'Customer', 'Sales', 'Advances']
